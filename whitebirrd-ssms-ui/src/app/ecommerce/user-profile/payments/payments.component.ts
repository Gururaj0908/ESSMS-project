...
export class PaymentsComponent implements OnInit {
  ...
  //   datepicker.close();
  // }
  constructor(private remoteService: RemoteService, media: MediaObserver,  public dialog: MatDialog,
    public fb: FormBuilder,  private successMessage: SuccessMessageService ) {
